...
class EditIncomeExample extends StatefulWidget {
  var updatetid = "";

  EditIncomeExample({required this.updatetid});

  @override
  State<EditIncomeExample> createState() => _EditIncomeExampleState();
}

class _EditIncomeExampleState extends State<EditIncomeExample> {
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: Center(child: Text("Income",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 14.0),))),
                ],
              ),
                  ...
                  onPressed: () async
                  {
                    ...
                    if(status==1)
                    {
                      ...
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context)=> HomePageExample(initialTabIndex: 2,))
                      );
                    }
                    else
                    {
