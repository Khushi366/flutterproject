import 'package:expensemanager/EditAllExample.dart';
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                              color: (snapshot.data![index]["types"].toString()=="Income")?Colors.green:Colors.red,
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                          onTap:(){
                                            ...
                                            var tid = snapshot.data![index]["tid"].toString();
                                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>EditAllExample(updatetid: tid,)));
