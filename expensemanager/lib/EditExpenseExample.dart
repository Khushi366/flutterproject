...
class EditExpenseExample extends StatefulWidget {
  var updatetid = "";

  EditExpenseExample({required this.updatetid});

  @override
  State<EditExpenseExample> createState() => _EditExpenseExampleState();
}

class _EditExpenseExampleState extends State<EditExpenseExample> {
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(child: Center(child: Text("Expense",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 14.0),))),
                ],
              ),
                  ...
                  onPressed: () async
                  {
                    ...
                    if(status==1)
                    {
                      ...
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context)=> HomePageExample(initialTabIndex: 1,))
                      );
                    }
                    else
                    {
